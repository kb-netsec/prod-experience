While building a new VLAN on the campus firewall HA pair, I had a copy/paste error and overwrote the VLAN ID. Thankfully I caught this before committing and discarded, however I'm interested to learn if this change would have triggered an HA failover. (I believe it would.) 
